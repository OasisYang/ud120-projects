...
print "The slope is " + str(reg.coef_)
print "The intercept is " + str(reg.intercept_)


print "The R-square of training data is " + str(reg.score(feature_train, target_train))
print "The R-square of testing data is " + str(reg.score(feature_test, target_test))
...
print "The slope of testing data without the outliers is " + str(reg.coef_)
